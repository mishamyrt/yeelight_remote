...
CONF_ON_DOUBLE_PRESS = "on_double_press"
...
CONFIG_SCHEMA = cv.COMPONENT_SCHEMA.extend(
    {
        ...
        cv.Optional(CONF_ON_DOUBLE_PRESS): automation.validate_automation(single=True),
...
async def to_code(config):
    ...
    if CONF_ON_DOUBLE_PRESS in config:
        await automation.build_automation(
            var.get_double_press_trigger(), [], config[CONF_ON_DOUBLE_PRESS]
        )
